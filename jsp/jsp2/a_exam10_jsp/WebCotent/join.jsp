...
<main id="section">
	...
	<form name="data" action="join_p.jsp" method="post" onsubmit="return checkValue()">
		<table class="table_line">
			...
			<tr>
				<th>가입일자</th>
				<td><input type="date" name="joindate" size="10" ></td>
			</tr>
			<tr>
				<th>고객등급</th>
				<td><input type="radio"  value="A" name="grade" size="10" > A-VIP
				<input type="radio"  value="B" name="grade" size="10"  checked="checked"> B-일반
				<input type="radio"  value="C" name="grade" size="10" > C-직원</td>
			</tr>
			<tr>
				<th>도시코드</th>
				<td>
					<select>
						...
						<option value="50" selected="selected">성남</option>
